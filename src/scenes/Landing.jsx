    ...
    >
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          I'm a full-stack developer with 3+ years of experience. I specialize in HTML, CSS, JavaScript, React, Framer Motion, Tailwind CSS, Express.js, Node.js, Multer, JWT, and SQL. My skills span the entire web development process, ensuring robust and efficient solutions from the frontend to the backend.
          </p>
        </motion.div>
        ...
        >
          ...
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-deep-blue font-playfair px-10 hover:text-red transition duration-500 w-full h-full flex items-center justify-center">
              Let's talk
            </div>
          </AnchorLink>
        </motion.div>
